...
- `file.storage.path` - необходимо указать название папки для сохранения файлов (звуков для сценариев). ВАЖНО: создать в корне проекта папку с названием, указанным в этом свойстве.
